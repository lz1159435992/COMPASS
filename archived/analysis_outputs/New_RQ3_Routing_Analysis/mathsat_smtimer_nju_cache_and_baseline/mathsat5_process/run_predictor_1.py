...
def main():
    ...
    parser.add_argument('--rl_dict_path', type=str,
                        default='/home/nju/constraint_solve_file/info_dict_rl.txt',
                        help='RL字典文件路径')
    parser.add_argument('--info_dict_path', type=str,
                        default='info_dict_SMTimer_llama3.1:70b_1200s_info_dict_rl_mathsat5_0628.txt',
                        help='信息字典文件路径')
    parser.add_argument('--result_dict_path', type=str,
                        default='/home/nju/PycharmProjects/Pearl/test_rl/test_cvc5/smtimer_710/mathsat5_smtimer_results_rl.json',
                        help='结果字典文件路径')
