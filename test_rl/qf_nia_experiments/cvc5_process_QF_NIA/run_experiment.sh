#!/bin/bash
# QF_NIA CVC5求解实验一键运行脚本

echo "=========================================="
echo "QF_NIA CVC5求解实验"
echo "=========================================="
echo ""
...
if [ -z "$MAX_FILES" ]; then
    python run_predictor.py --solver cvc5 --timeout 1200 2>&1 | tee log/experiment.log
else
    python run_predictor.py --solver cvc5 --timeout 1200 --max_files $MAX_FILES 2>&1 | tee log/experiment.log
fi
echo "实验完成！"
echo ""
