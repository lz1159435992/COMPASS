...
def test_group_bert_normalize_1by1_smt_name_2_QF_NIA():
    ...
    # 读取QF_NIA求解结果
    with open(os.path.join(config.TEST_RL_ROOT, 'test_QF_NIA', 'cvc5_QF_NIA.json'), 'r') as file:
    ...
    # 设置输出路径
    output_path = os.path.join(config.TEST_RL_ROOT, 'test_QF_NIA', 'cvc5_process_QF_NIA', 'features')
    logic_name = 'QF_NIA'
