...
def test_bvparti_solver_only():
    ...
    try:
        from test_rl.smtimer_experiments.bvparti_process.run_bvparti_predictor import BVPartiSolver
...
def show_command_examples():
    ...
    examples = [
        {
            "name": "基本用法（使用BVParti）",
            "command": """python test_rl/smtimer_experiments/bvparti_process/run_bvparti_predictor.py \\
    --solver bvparti \\
...
def main():
    ...
    print("演示完成！")
    print("\n要运行完整的预测器，请使用以下命令:")
    print("python test_rl/smtimer_experiments/bvparti_process/run_bvparti_predictor.py --help")
