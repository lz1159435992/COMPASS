...
def test_file_comparison():
    ...
    try:
        ...
        # 文件路径
        old_file = os.path.join(config.BVPARTI_HOME, 'scripts', 'batch_output', 'bv_default', 'SMTimer_z3_result_predictor.json')
        new_file = os.path.join(config.BVPARTI_HOME, 'scripts', 'batch_output', 'bv_default', 'SMTimer_z3_result_rl.json')
