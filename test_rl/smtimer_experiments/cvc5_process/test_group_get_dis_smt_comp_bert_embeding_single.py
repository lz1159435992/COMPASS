...
if __name__ == '__main__':
    ...
    run_complete_process(
        ...
        solve_dict_path=os.path.join(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..')), 'test_rl', 'smtimer_experiments', 'cvc5_smtimer_results_predictor.json'),
        features_dir=os.path.join(config.TEST_RL_ROOT, 'features'),
